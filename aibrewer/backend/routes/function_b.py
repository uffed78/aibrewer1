...
from ..brewfather_api import get_inventory, get_all_inventory, get_inventory_item
...
@function_b_bp.route('/inventory/all', methods=['GET'])
def all_inventory():
    """
...
@function_b_bp.route('/inventory/<category>/<item_id>', methods=['GET'])
